"""Load the selected gender model and classify one image."""
...
MODEL_PATH = ROOT / "models" / "gender_model.keras"
...
def classify_gender(image_path: str | Path, model_path: str | Path = MODEL_PATH) -> dict:
...
if __name__ == "__main__":
    ...
    classify_gender(args.image, args.model)
